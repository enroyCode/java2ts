...
import com.enroy.java2ts.core.config.Java2TsProperties;
import com.enroy.java2ts.core.config.RuntimeExProperties;
import com.enroy.java2ts.core.entity.ApiEntity;
import com.enroy.java2ts.core.rt.resolver.entity.DefaultValueResolver;
import com.enroy.java2ts.core.rt.resolver.entity.EntityNameResolver;
import com.enroy.java2ts.core.rt.resolver.entity.JavaTypeResolver;
import com.enroy.java2ts.core.rt.resolver.entity.ModelTypeNameResolver;
import com.enroy.java2ts.core.rt.resolver.file.ApiWriteResolver;
import com.enroy.java2ts.core.rt.resolver.file.ModelWriteResolver;
import com.enroy.java2ts.core.rt.resolver.file.OutputPathResolver;
import com.enroy.java2ts.core.rt.resolver.file.WorkspaceResolver;
import com.enroy.java2ts.core.rt.resolver.loader.ApiEntityLoadResolver;
import com.enroy.java2ts.core.rt.resolver.loader.ModelEntityLoadResolver;
import lombok.Data;
