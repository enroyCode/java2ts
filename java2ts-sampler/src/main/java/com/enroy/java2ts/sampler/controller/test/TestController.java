package com.enroy.java2ts.sampler.controller.test;

import com.enroy.java2ts.sampler.api.TestApi;
import com.enroy.java2ts.sampler.api.TestReq;
import com.enroy.java2ts.sampler.domain.Res;
import com.enroy.java2ts.sampler.domain.TestDto;
